...
const activities: ActivityDescriptor[] = [
  ...
  { id: "clipboard_ai_transfer", label: "Clipboard AI Transfer", category: "AI", status: "available", description: "Context-aware copy/paste normalization between workflow contexts." },
  { id: "document_understanding", label: "Document Understanding", category: "AI", status: "available", description: "Extract structured fields from raw document text." },
  ...
  { id: "orchestrator_queue", label: "Orchestrator Queue", category: "Management", status: "available", description: "Manage queue-based workloads." },
